...
namespace dooqu_server
{
	namespace ddz
	{
		...
		protected:
			...
			virtual void on_game_start(void*, void*, int);
			virtual void on_game_bid(void*, void*, int);
			virtual void on_game_landlord(void* desk, void*, int);
			virtual void on_robot_card(void*, void*, int);
		...
		public:
			ddz_plugin(game_service*, char* game_id, char* title, double frequence, int game_argc, char* game_argv[]);
			virtual ~ddz_plugin();
